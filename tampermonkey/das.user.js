// ==UserScript==
// @name         CMS-OC WebOps - Open DAS Page
// @namespace    https://github.com/DickyChant/CMS-OC-WebOps
// @version      1.0
// @description  Open CMS Data Aggregation System (DAS) with the selected dataset or query
...
(function () {
    ...
    const TITLE = 'Open DAS Page';
    const BASE_URL = 'https://cmsweb.cern.ch/das/request?view=list&limit=50&instance=prod%2Fglobal&input={text}';
