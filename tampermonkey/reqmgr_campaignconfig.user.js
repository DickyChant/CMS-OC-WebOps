// ==UserScript==
// @name         CMS-OC WebOps - Open Campaign Config
// @namespace    https://github.com/DickyChant/CMS-OC-WebOps
// @version      1.0
// @description  Open ReqMgr2 campaign configuration with the selected campaign name
...
(function () {
    ...
    const TITLE = 'Open Campaign Config';
    const BASE_URL = 'https://cmsweb.cern.ch/reqmgr2/data/campaignconfig/{text}';
