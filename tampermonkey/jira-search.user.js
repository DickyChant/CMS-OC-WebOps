// ==UserScript==
// @name         CMS-OC WebOps - Jira Search
// @namespace    https://github.com/DickyChant/CMS-OC-WebOps
// @version      1.0
// @description  Search Jira (CMSPROD / CMSCOMPPR projects) with the selected text
...
(function () {
    ...
    const TITLE = 'Open Jira';
    const BASE_URL = 'https://its.cern.ch/jira/issues/?jql=text~{text}%20AND%20(project%20%3D%20CMSPROD%20OR%20project%20%3D%20CMSCOMPPR)';
