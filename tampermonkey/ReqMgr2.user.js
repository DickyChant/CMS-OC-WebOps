// ==UserScript==
// @name         CMS-OC WebOps - Open ReqMgr2
// @namespace    https://github.com/DickyChant/CMS-OC-WebOps
// @version      1.0
// @description  Open CMS ReqMgr2 request page with the selected request ID
...
(function () {
    ...
    const TITLE = 'Open ReqMgr2';
    const BASE_URL = 'https://cmsweb.cern.ch/reqmgr2/fetch?rid={text}';
