// ==UserScript==
// @name         CMS-OC WebOps - Open Rucio Web UI
// @namespace    https://github.com/DickyChant/CMS-OC-WebOps
// @version      1.0
// @description  Open CMS Rucio Web UI search with the selected dataset or DID
...
(function () {
    ...
    const TITLE = 'Open Rucio Web UI';
    const BASE_URL = 'https://cms-rucio-webui.cern.ch/search?pattern=cms:{text}';
