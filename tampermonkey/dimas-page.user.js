// ==UserScript==
// @name         CMS-OC WebOps - Open Dima's Page
// @namespace    https://github.com/DickyChant/CMS-OC-WebOps
// @version      1.0
// @description  Open Dima's CMS production monitor page with the selected workflow/prep_id
...
(function () {
    ...
    const TITLE = "Open Dima's Page";
    const BASE_URL = 'https://dmytro.web.cern.ch/dmytro/cmsprodmon/workflows.php?prep_id={text}';
